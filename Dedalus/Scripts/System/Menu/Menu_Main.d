...
const int MENU_MAIN_Y = 3000;

instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "(: Zmieñ ustawienia i wyjdŸ :)";
	text[1] = "Gothic PurpleClient";
	posx = 0;
	posy = MENU_MAIN_Y + (MENU_MAIN_DY * 0);
	dimx = 8100;
	dimy = 750;
	onSelAction[0]	= SEL_ACTION_CLOSE; //dev
	onSelAction_S[0]= "NEW_GAME"; //dev
	
	//onselaction[0] = SEL_ACTION_BACK; //rel
	//onSelAction_S[0]= "MENU_LEAVE_GAME"; //rel
