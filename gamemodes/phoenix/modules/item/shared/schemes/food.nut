...
phoenix.item.register("ITFO_MUTTON"           , fo(  15,  99, "ItFo_Mutton.3DS",           "Baranina pieczona",      { kind = "heal", data = { hp = 12 } }))
phoenix.item.register("ITFO_MUTTONRAW"        , fo(   5,  99, "ItFo_MuttonRaw.3DS",        "Baranina surowa",        { kind = "heal", data = { hp = 3 } }))
