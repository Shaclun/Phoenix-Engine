...
phoenix.item.register("ITMI_LEATHER"            , m(   5, 999, "ItMi_Leather.3DS",            "Skora",               "Surowa skora."))
phoenix.item.register("ITMI_FUR"                , m(  10, 999, "ItMi_Fur.3DS",                "Futro",               "Geste futro."))
phoenix.item.register("ITMI_BONE"               , m(   3, 999, "ItMi_Bone.3DS",               "Kosc",                "Kawalek kosci."))
phoenix.item.register("ITMI_TEETH"              , m(   8, 999, "ItMi_Teeth.3DS",              "Zeby",                "Ostre zeby."))
