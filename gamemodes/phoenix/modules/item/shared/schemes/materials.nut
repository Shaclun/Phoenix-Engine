...
local wolfFur = m(10, 999, "ITAT_WOLFFUR.3DS", "Futro", "Gęste futro.")
local teeth = m(8, 999, "ITAT_TEETH.3DS", "Zęby", "Ostre zęby.")
local claw = m(10, 999, "ITAT_CLAW.3DS", "Pazur", "Ostry pazur.")
phoenix.item.register("ITAT_WOLFFUR", wolfFur)
phoenix.item.register("ITAT_TEETH", teeth)
phoenix.item.register("ITAT_CLAW", claw)
// Legacy IDs remain readable for items obtained before canonical hunting loot was introduced.
phoenix.item.register("ITMI_FUR", wolfFur)
phoenix.item.register("ITMI_TEETH", teeth)
phoenix.item.register("ITMI_CLAW", claw)
