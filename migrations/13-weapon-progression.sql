...
ON DUPLICATE KEY UPDATE `level` = GREATEST(`phoenix_character_weapon_progress`.`level`, VALUES(`level`)), `cap` = GREATEST(`phoenix_character_weapon_progress`.`cap`, VALUES(`cap`));
